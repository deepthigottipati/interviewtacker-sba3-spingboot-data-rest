...
public class UserRestController {
	...
	public List<Interview> retrieveAllUsers(@PathVariable int id) {
	...
	public ResponseEntity<Object> createPost(@PathVariable int id, @RequestBody Interview interview) {
		...
		URI location = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(interview.getId())
				.toUri();
